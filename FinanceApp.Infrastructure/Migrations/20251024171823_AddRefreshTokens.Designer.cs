...
namespace FinanceApp.Infrastructure.Migrations
{
    ...
    [Migration("20251024171823_AddRefreshTokens")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinanceApp.Dbo.Models.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("FinanceApp.Dbo.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "SUPER_ADMIN",
                            CreatedAt = new DateTime(2025, 10, 24, 17, 18, 23, 623, DateTimeKind.Utc).AddTicks(9660),
                            Description = "Полный доступ ко всей системе",
                            IsSystem = true,
                            Name = "Суперадминистратор",
                            Permissions = "[\"*\"]",
                            UpdatedAt = new DateTime(2025, 10, 24, 17, 18, 23, 623, DateTimeKind.Utc).AddTicks(9790)
                        },
                        new
                        {
                            Id = new Guid("22222222-2222-2222-2222-222222222222"),
                            Code = "ADMIN",
                            CreatedAt = new DateTime(2025, 10, 24, 17, 18, 23, 623, DateTimeKind.Utc).AddTicks(9900),
                            Description = "Управление пользователями и настройками",
                            IsSystem = true,
                            Name = "Администратор",
                            Permissions = "[\"users.manage\",\"settings.manage\",\"roles.manage\"]",
                            UpdatedAt = new DateTime(2025, 10, 24, 17, 18, 23, 623, DateTimeKind.Utc).AddTicks(9900)
                        },
                        new
                        {
            ...
            modelBuilder.Entity("FinanceApp.Dbo.Models.Tag", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Color = "#4CAF50",
                            CreatedAt = new DateTime(2025, 10, 24, 17, 18, 23, 624, DateTimeKind.Utc).AddTicks(4340),
                            Icon = "💰",
                            IsActive = true,
                            IsSystem = true,
                            Level = 0,
                            ...
                            Slug = "salary",
                            Type = "Income",
                            UpdatedAt = new DateTime(2025, 10, 24, 17, 18, 23, 624, DateTimeKind.Utc).AddTicks(4440),
                            UsageCount = 0,
                            Visibility = "Public"
                        },
                        new
                        {
                            ...
                            Color = "#F44336",
                            CreatedAt = new DateTime(2025, 10, 24, 17, 18, 23, 624, DateTimeKind.Utc).AddTicks(4540),
                            Icon = "🛒",
                            IsActive = true,
                            IsSystem = true,
                            Level = 0,
                            ...
                            Slug = "groceries",
                            Type = "Expense",
                            UpdatedAt = new DateTime(2025, 10, 24, 17, 18, 23, 624, DateTimeKind.Utc).AddTicks(4540),
                            UsageCount = 0,
                            Visibility = "Public"
                        },
                        new
                        {
                            ...
                            Color = "#FF9800",
                            CreatedAt = new DateTime(2025, 10, 24, 17, 18, 23, 624, DateTimeKind.Utc).AddTicks(4550),
                            Icon = "🚗",
                            IsActive = true,
                            IsSystem = true,
                            Level = 0,
                            ...
                            Slug = "transport",
                            Type = "Expense",
                            UpdatedAt = new DateTime(2025, 10, 24, 17, 18, 23, 624, DateTimeKind.Utc).AddTicks(4560),
                            UsageCount = 0,
                            Visibility = "Public"
                        },
                        new
                        {
                            ...
                            Color = "#9C27B0",
                            CreatedAt = new DateTime(2025, 10, 24, 17, 18, 23, 624, DateTimeKind.Utc).AddTicks(4560),
                            Icon = "🎮",
                            IsActive = true,
                            IsSystem = true,
                            Level = 0,
